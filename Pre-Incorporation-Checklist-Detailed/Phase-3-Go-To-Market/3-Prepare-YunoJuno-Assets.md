# Pre-Incorporation: Prepare YunoJuno Assets

## The Objective
YunoJuno requires verification of your Limited Company status and Professional Indemnity (PI) Insurance before your profile goes live. However, writing high-converting profile copy takes hours. Do the writing now.

## Step 1: Draft the Profile Bio
Open a standard text file and draft your exact profile using this verified UK 2026 structure:

**Headline:** Specialist in UK Legacy Code Rescue & Technical Debt Reduction

**Bio:** 
> "I act as an asynchronous technical maintenance desk for UK agencies and funded startups. I do not build applications from scratch. Instead, I parachute into existing React, Node.js, and Rust codebases to resolve critical production bugs, execute complex dependency upgrades, and stabilise degrading infrastructure. If your internal team is too busy building features to fix post-launch headaches, I can take over your automated maintenance."
